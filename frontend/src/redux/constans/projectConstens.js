...
export const PROJECT_CREATE__REST = "PROJECT_CREATE__REST";
...
export const PROJECT_UPDATE_REST = "PROJECT_UPDATE_REST";
...
export const PROJECT_DEATAILS_SUCCESS = "PROJECT_DEATAILS_SUCCESS";
